...
from models import build_actor_forward_fn, build_continuous_actor, build_continuous_critic
...
if __name__ == "__main__":
    raise SystemExit("Use one of the train_generic_ddpg/td3 entrypoint scripts.")
